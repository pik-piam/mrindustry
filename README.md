...
R package **mrindustry**, version **1.3.4**
...
Benke F, Dürrwächter J, Rodrigues R, Moreno-Leiva S, Baumstark L, Pehl M, Weiss B (2026). "mrindustry: input data generation for the REMIND industry module." Version: 1.3.4, <https://github.com/pik-piam/mrindustry>.
