...
R package **mrindustry**, version **0.24.5.9001**
...
Benke F, Dürrwächter J, Rodrigues R, Moreno-Leiva S, Baumstark L, Pehl M, Weiss B (2025). "mrindustry: input data generation for the REMIND industry module." Version: 0.24.5.9001, <https://github.com/pik-piam/mrindustry>.
