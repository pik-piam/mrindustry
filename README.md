...
R package **mrindustry**, version **0.15.0.9001**
...
Benke F, Dürrwächter J, Rodrigues R, Moreno-Leiva S, Baumstark L, Pehl M (2025). "mrindustry: input data generation for the REMIND industry module." Version: 0.15.0.9001, <https://github.com/pik-piam/mrindustry>.
