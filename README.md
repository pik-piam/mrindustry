...
R package **mrindustry**, version **1.0.0**
...
Benke F, Dürrwächter J, Rodrigues R, Moreno-Leiva S, Baumstark L, Pehl M, Weiss B (2025). "mrindustry: input data generation for the REMIND industry module." Version: 1.0.0, <https://github.com/pik-piam/mrindustry>.
